...
Neste projeto trabalhamos com dados oficiais do governo brasileiro sobre queimadas do ano de 1998 a 2017. Foi possível treinar a confecção de mapas com os pacotes geobr e sf. Podemos ver que a partir de uma base de dados tratada ([Tidy data](https://cran.r-project.org/web/packages/tidyr/vignettes/tidy-data.html)) fomos capazes de extrair as informações necessárias dos dados. Como atividade complementar a este projeto confeccionei no Tableau uma Dashboard que pode ser acessada [aqui](https://public.tableau.com/app/profile/tales.gomes/viz/FocosdeincndiosnoBrasil1998a2017/FocosdeincndionoBrasil).
